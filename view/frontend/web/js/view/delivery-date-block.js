define([
    ...
    return Component.extend({
        defaults: {
            template: 'Magikkart_DeliveryDate/delivery-date-block'
        },
        initialize: function () {
            this._super();
            ...
            var totalDays = window.checkoutConfig.shipping.delivery_date.totalDays;
            var format = window.checkoutConfig.shipping.delivery_date.format;
            var slot = window.checkoutConfig.shipping.delivery_date.slot;
